...
export class HomePage extends BasePage {
  ...
  /**
   * Navigate to the Profile page and wait for URL change.
   * Combines navigation + URL wait in one semantic flow.
   */
  async navigateToProfilePage(): Promise<void> {
    this.logger.info('Navigating to Profile page');
    await this.navigationBar.goToProfile();
